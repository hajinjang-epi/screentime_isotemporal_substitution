...
* e4;
%iso(base4_e4,obesity1920,);
%iso(base4_e4,obesity1920, ctime9w1 ctime10w1); *sp;
%iso(base4_e4,obesity1920, ctimespw1 ctime10w1); *com;
%iso(base4_e4,obesity1920, ctimespw1 ctime9w1); *tv;
* m1;
%iso(base4_m1,obesity1920,);
%iso(base4_m1,obesity1920, ctime9w1 ctime10w1); *sp;
%iso(base4_m1,obesity1920, ctimespw1 ctime10w1); *com;
%iso(base4_m1,obesity1920, ctimespw1 ctime9w1); *tv;
...
%suppl(e4,sp_usew1h,obesityw1,sexw1,incomew1(ref="3"),incomew1);
%suppl(e4,dayuse9w1h,obesityw1,sexw1,incomew1(ref="3"),incomew1);
%suppl(e4,dayuse10w1h,obesityw1,sexw1,incomew1(ref="3"),incomew1);
/*income*/
%suppl(e4,total_stw1h,obesityw1,incomew1,sexw1(ref="1"),sexw1);
%suppl(e4,sp_usew1h,obesityw1,incomew1,sexw1(ref="1"),sexw1);
%suppl(e4,dayuse9w1h,obesityw1,incomew1,sexw1(ref="1"),sexw1);
%suppl(e4,dayuse10w1h,obesityw1,incomew1,sexw1(ref="1"),sexw1);

/*m1*/
/*sex*/
%suppl(m1,total_stw1h,obesityw1,sexw1,incomew1(ref="3"),incomew1);
%suppl(m1,sp_usew1h,obesityw1,sexw1,incomew1(ref="3"),incomew1);
%suppl(m1,dayuse9w1h,obesityw1,sexw1,incomew1(ref="3"),incomew1);
%suppl(m1,dayuse10w1h,obesityw1,sexw1,incomew1(ref="3"),incomew1);
/*income*/
%suppl(m1,total_stw1h,obesityw1,incomew1,sexw1(ref="1"),sexw1);
%suppl(m1,sp_usew1h,obesityw1,incomew1,sexw1(ref="1"),sexw1);
%suppl(m1,dayuse9w1h,obesityw1,incomew1,sexw1(ref="1"),sexw1);
%suppl(m1,dayuse10w1h,obesityw1,incomew1,sexw1(ref="1"),sexw1);
