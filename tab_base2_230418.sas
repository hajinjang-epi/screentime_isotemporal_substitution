* change_obe;
proc freq data=e4;table change_obe;run;
proc freq data=m1;table change_obe;run;

proc surveyfreq data=e4; 
weight weightb1w4;
table change_obe; run;
proc surveyfreq data=m1; 
weight weightb1w4;
table change_obe; run;

proc sort data=e4; by bmi_cw4; run;
proc means data=e4 mean median min max sum; by bmi_cw4; var bmi_change; run; 
proc surveymeans data=e4 mean median min max sum; 
weight weighta1w4;
by bmi_cw4; 
var bmi_change; run; 

proc sort data=m1; by bmi_cw4; run;
proc means data=m1 mean median min max sum; by bmi_cw4; var bmi_change; run; 
proc surveymeans data=m1 mean median min max sum; 
weight weighta1w4;
by bmi_cw4; 
var bmi_change; run; 
...
* e4;
%or(test_e4,total_re,obe_any,);
%or(test_e4,sp_new,obe_any,);
%or(test_e4,com_new,obe_any,);
%or(test_e4,tv_new,obe_any,);

%or(test_e4,sp_new,obe_any,dayuse9w1h dayuse10w1h);
%or(test_e4,com_new,obe_any,sp_usew1h dayuse10w1h);
%or(test_e4,tv_new,obe_any,sp_usew1h dayuse9w1h);


* m1;
%or(test_m1,total_re,obe_any,);
%or(test_m1,sp_new,obe_any,);
%or(test_m1,com_new,obe_any,);
%or(test_m1,tv_new,obe_any,);

%or(test_m1,sp_new,obe_any,dayuse9w1h dayuse10w1h);
%or(test_m1,com_new,obe_any,sp_usew1h dayuse10w1h);
%or(test_m1,tv_new,obe_any,sp_usew1h dayuse9w1h);
...
data test_all; set test_e4 test_m1; run;

%inter(test_all,total_re,obe_any,);
%inter(test_all,sp_new,obe_any,);
%inter(test_all,com_new,obe_any,);
%inter(test_all,tv_new,obe_any,);

%inter(test_all,sp_new,obe_any,dayuse9w1h dayuse10w1h);
%inter(test_all,com_new,obe_any,sp_usew1h dayuse10w1h);
%inter(test_all,tv_new,obe_any,sp_usew1h dayuse9w1h);
...
%or(test_e4,com_new,obe_2021,);
%or(test_e4,tv_new,obe_2021,);

%or(test_e4,sp_re,obe_2021,dayuse9w1h dayuse10w1h);
%or(test_e4,com_new,obe_2021,sp_usew1h dayuse10w1h);
%or(test_e4,tv_new,obe_2021,sp_usew1h dayuse9w1h);

* m1;
%or(test_m1,total_re,obe_2021,);
%or(test_m1,sp_re,obe_2021,);
%or(test_m1,com_new,obe_2021,);
%or(test_m1,tv_new,obe_2021,);

%or(test_m1,sp_re,obe_2021,dayuse9w1h dayuse10w1h);
%or(test_m1,com_new,obe_2021,sp_usew1h dayuse10w1h);
%or(test_m1,tv_new,obe_2021,sp_usew1h dayuse9w1h);

%inter(test_all,total_re,obe_2021,);
%inter(test_all,sp_re,obe_2021,);
%inter(test_all,com_new,obe_2021,);
%inter(test_all,tv_new,obe_2021,);

%inter(test_all,sp_re,obe_2021,dayuse9w1h dayuse10w1h);
%inter(test_all,com_new,obe_2021,sp_usew1h dayuse10w1h);
%inter(test_all,tv_new,obe_2021,sp_usew1h dayuse9w1h);


/** obe_maintain **/
%or(test_e4,total_re,obe_maintain,);
%or(test_e4,sp_re,obe_maintain,);
%or(test_e4,com_new,obe_maintain,);
%or(test_e4,tv_new,obe_maintain,);

%or(test_e4,sp_re,obe_maintain,dayuse9w1h dayuse10w1h);
%or(test_e4,com_new,obe_maintain,sp_usew1h dayuse10w1h);
%or(test_e4,tv_new,obe_maintain,sp_usew1h dayuse9w1h);

* m1;
%or(test_m1,total_re,obe_maintain,);
%or(test_m1,sp_re,obe_maintain,);
%or(test_m1,com_new,obe_maintain,);
%or(test_m1,tv_new,obe_maintain,);

%or(test_m1,sp_re,obe_maintain,dayuse9w1h dayuse10w1h);
%or(test_m1,com_new,obe_maintain,sp_usew1h dayuse10w1h);
%or(test_m1,tv_new,obe_maintain,sp_usew1h dayuse9w1h);

%inter(test_all,total_re,obe_maintain,);
%inter(test_all,sp_re,obe_maintain,);
%inter(test_all,com_new,obe_maintain,);
%inter(test_all,tv_new,obe_maintain,);

%inter(test_all,sp_re,obe_maintain,dayuse9w1h dayuse10w1h);
%inter(test_all,com_new,obe_maintain,sp_usew1h dayuse10w1h);
%inter(test_all,tv_new,obe_maintain,sp_usew1h dayuse9w1h);
...
/*cross-sectional (2018)*/
* e4;
%or(add_e4,total_re,long_obe,);
%or(add_e4,sp_new,long_obe,);
%or(add_e4,com_new,long_obe,);
%or(add_e4,tv_new,long_obe,);

%or(add_e4,sp_new,long_obe,dayuse9w2h dayuse10w2h);
%or(add_e4,com_new,long_obe,sp_usew2h dayuse10w2h);
%or(add_e4,tv_new,long_obe,sp_usew2h dayuse9w2h);

* m1;
%or(add_m1,total_re,long_obe,);
%or(add_m1,sp_new,long_obe,);
%or(add_m1,com_new,long_obe,);
%or(add_m1,tv_new,long_obe,);

%or(add_m1,sp_new,long_obe,dayuse9w2h dayuse10w2h);
%or(add_m1,com_new,long_obe,sp_usew2h dayuse10w2h);
%or(add_m1,tv_new,long_obe,sp_usew2h dayuse9w2h);
...
run;
%mend inter;
data add_all; set add_e4 add_m1; run;

%inter(add_all,total_re,long_obe,);
%inter(add_all,sp_new,long_obe,);
%inter(add_all,com_new,long_obe,);
%inter(add_all,tv_new,long_obe,);

%inter(add_all,sp_new,long_obe,dayuse9w2h dayuse10w2h);
%inter(add_all,com_new,long_obe,sp_usew2h dayuse10w2h);
%inter(add_all,tv_new,long_obe,sp_usew2h dayuse9w2h);
...
weight weightb1w4;
class &out.(ref="0") sexw1(ref="1") famnumw2(ref="2") pschoolw2(ref="2") incomew2(ref="3") gradew2(ref="2") / param=ref;
model &out.= sleep_all_h ctime8w2 ctime11w2 ctime2w2 ctimestudyw2 ctime7w2 &cov. 
sexw1 famnumw2 pschoolw2 incomew2 gradew2 parcaresumw2;
run;
%mend iso;

/*2019-2020*/
* e4;
%iso(base5_e4,obesity2021,);
%iso(base5_e4,obesity2021, ctime9w2 ctime10w2); *sp;
%iso(base5_e4,obesity2021, ctimespw2 ctime10w2); *com;
%iso(base5_e4,obesity2021, ctimespw2 ctime9w2); *tv;
* m1;
%iso(base5_m1,obesity2021,);
%iso(base5_m1,obesity2021, ctime9w2 ctime10w2); *sp;
%iso(base5_m1,obesity2021, ctimespw2 ctime10w2); *com;
%iso(base5_m1,obesity2021, ctimespw2 ctime9w2); *tv;
...
/* ordinal logistic */
%macro ord(data,ex,out,cov);
proc freq data=&data.; 
table &ex.*&out.; 
run;
proc surveylogistic data=&data. nomcar; 
weight weightb1w4;
class bmicatw1(ref="4") &out. &ex.(ref="2") sexw1(ref="1") famnumw1(ref="2") pschoolw1(ref="2") incomew1(ref="3") gradew1(ref="2") / param=ref;
model &out.(desc)= &ex. bmicatw1 sexw1 famnumw1 pschoolw1 incomew1 gradew1 parcaresumw1 &cov.;
run;
proc surveylogistic data=&data. nomcar; 
weight weightb1w4;
class bmicatw1(ref="4") &out. sexw1(ref="1") famnumw1(ref="2") pschoolw1(ref="2") incomew1(ref="3") gradew1(ref="2") / param=ref;
model &out.(desc)= &ex. bmicatw1 sexw1 famnumw1 pschoolw1 incomew1 gradew1 parcaresumw1 &cov.;
run;
%mend ord;
...
/**/
* e4;
%ord(ord_e4,total_re,bmicatw4,);
%ord(ord_e4,sp_new,bmicatw4,);
%ord(ord_e4,com_new,bmicatw4,);
%ord(ord_e4,tv_new,bmicatw4,);

%ord(ord_e4,sp_new,bmicatw4,dayuse9w1h dayuse10w1h);
%ord(ord_e4,com_new,bmicatw4,sp_usew1h dayuse10w1h);
%ord(ord_e4,tv_new,bmicatw4,sp_usew1h dayuse9w1h);


* m1;
%ord(ord_m1,total_re,bmicatw4,);
%ord(ord_m1,sp_new,bmicatw4,);
%ord(ord_m1,com_new,bmicatw4,);
%ord(ord_m1,tv_new,bmicatw4,);

%ord(ord_m1,sp_new,bmicatw4,dayuse9w1h dayuse10w1h);
%ord(ord_m1,com_new,bmicatw4,sp_usew1h dayuse10w1h);
%ord(ord_m1,tv_new,bmicatw4,sp_usew1h dayuse9w1h);

*grade_interaction;
%macro inter_ord(data,ex,out,cov);
proc surveylogistic data=&data. nomcar; 
weight weightb1w4;
class bmicatw1(ref="4") &out. &ex.(ref="2") schoolw1(ref="1") sexw1(ref="1") famnumw1(ref="2") pschoolw1(ref="2") incomew1(ref="3") gradew1(ref="2") / param=ref;
model &out.(desc)= &ex.*schoolw1 &ex. schoolw1 bmicatw1 sexw1 famnumw1 pschoolw1 incomew1 gradew1 parcaresumw1 &cov.;
run;
%mend inter_ord;

data ord_all; set ord_e4 ord_m1; run;

%inter_ord(ord_all,total_re,bmicatw4,);
%inter_ord(ord_all,sp_new,bmicatw4,);
%inter_ord(ord_all,com_new,bmicatw4,);
%inter_ord(ord_all,tv_new,bmicatw4,);

%inter_ord(ord_all,sp_new,bmicatw4,dayuse9w1h dayuse10w1h);
%inter_ord(ord_all,com_new,bmicatw4,sp_usew1h dayuse10w1h);
%inter_ord(ord_all,tv_new,bmicatw4,sp_usew1h dayuse9w1h);
