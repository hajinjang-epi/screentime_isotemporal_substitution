libname a 'C:\Users\HajinJang\OneDrive - University of Pittsburgh\PITT\PROJECTS\SCREENTIME\0_230201_screen_diet\KCYPS2018_all';
data kcyps18_e4;
...
/* Exclusion */
*remove activity times missing;
data cohort1; set all;
if ctime8w1=. or ctime7w1=. or sleep_all_h=. or ctime11w1=. or ctimestudyw1=. or ctime2w1=. or ctime9w1=. or ctime10w1=. or ctimespw1=. then delete;
run;
*remove height and weight missing;
...
/* Final datasets */
* cross_pool;
data cross_pool; set cohort2; run;
* cross_e4;
data cross_e4; set cross_pool;
if schoolw1=1; run;
* cross_m1;
data cross_m1; set cross_pool;
if schoolw1=2; run;
