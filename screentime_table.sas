...
%mend or;
*base2_e4;
%or(base5_e4,total_re,obesity2021,);
%or(base5_e4,sp_new,obesity2021,);
%or(base5_e4,com_new,obesity2021,);
%or(base5_e4,tv_new,obesity2021,);

%or(base5_e4,sp_new,obesity2021,dayuse9w2h dayuse10w2h);
%or(base5_e4,com_new,obesity2021,sp_usew2h dayuse10w2h);
%or(base5_e4,tv_new,obesity2021,sp_usew2h dayuse9w2h);


* m1;
%or(base5_m1,total_re,obesity2021,);
%or(base5_m1,sp_new,obesity2021,);
%or(base5_m1,com_new,obesity2021,);
%or(base5_m1,tv_new,obesity2021,);

%or(base5_m1,sp_new,obesity2021,dayuse9w2h dayuse10w2h);
%or(base5_m1,com_new,obesity2021,sp_usew2h dayuse10w2h);
%or(base5_m1,tv_new,obesity2021,sp_usew2h dayuse9w2h);
...
data base5_all; set base5_e4 base5_m1; run;

%inter(base5_all,total_re,obesity2021,);
%inter(base5_all,sp_new,obesity2021,);
%inter(base5_all,com_new,obesity2021,);
%inter(base5_all,tv_new,obesity2021,);

%inter(base5_all,sp_new,obesity2021,dayuse9w2h dayuse10w2h);
%inter(base5_all,com_new,obesity2021,sp_usew2h dayuse10w2h);
%inter(base5_all,tv_new,obesity2021,sp_usew2h dayuse9w2h);
