...
/*스마트폰 이용시간*/
*평일;
if ytim1k01w3=1 then sp_use_wdw3=0;
else if ytim1k01w3=2 then sp_use_wdw3=15;
else if ytim1k01w3=3 then sp_use_wdw3=45;
else if ytim1k01w3=4 then sp_use_wdw3=90;
else if ytim1k01w3=5 then sp_use_wdw3=150;
else if ytim1k01w3=6 then sp_use_wdw3=210;
else if ytim1k01w3=7 then sp_use_wdw3=270;
sp_use_wdw3h=sp_use_wdw3/60; *단위를 시간으로변환;
*주말;
if ytim1k02w3=1 then sp_use_wkw3=0;
else if ytim1k02w3=2 then sp_use_wkw3=15;
else if ytim1k02w3=3 then sp_use_wkw3=45;
else if ytim1k02w3=4 then sp_use_wkw3=90;
else if ytim1k02w3=5 then sp_use_wkw3=150;
else if ytim1k02w3=6 then sp_use_wkw3=210;
else if ytim1k02w3=7 then sp_use_wkw3=270;
sp_use_wkw3h=sp_use_wkw3/60; *단위를 시간으로변환;
*일주일평균;
sp_usew3=sum(sp_use_wdw3*5, sp_use_wkw3*2)/7;
sp_usew3h=sp_usew3/60;


/*수면시간*/
*평일;
wake_wd=hms(ytim1a01w3, ytim1a02w3, 0);
bed_wd=hms(ytim1b01w3, ytim1b02w3, 0);
...
*주말;
wake_wk=hms(ytim1a03w3, ytim1a04w3, 0);
bed_wk=hms(ytim1b03w3, ytim1b04w3, 0);
...
/*부모님 대화시간*/
*평일;
if ytim1d01w3=1 then dayuse2_wdw3=0;
else if ytim1d01w3=2 then dayuse2_wdw3=15;
else if ytim1d01w3=3 then dayuse2_wdw3=45;
else if ytim1d01w3=4 then dayuse2_wdw3=90;
else if ytim1d01w3=5 then dayuse2_wdw3=150;
else if ytim1d01w3=6 then dayuse2_wdw3=210;
else if ytim1d01w3=7 then dayuse2_wdw3=270;
dayuse2_wdw3h=dayuse2_wdw3/60;
*주말;
if ytim1d02w3=1 then dayuse2_wkw3=0;
else if ytim1d02w3=2 then dayuse2_wkw3=15;
else if ytim1d02w3=3 then dayuse2_wkw3=45;
else if ytim1d02w3=4 then dayuse2_wkw3=90;
else if ytim1d02w3=5 then dayuse2_wkw3=150;
else if ytim1d02w3=6 then dayuse2_wkw3=210;
else if ytim1d02w3=7 then dayuse2_wkw3=270;
dayuse2_wkw3h=dayuse2_wkw3/60;
*일주일평균;
dayuse2w3=sum(dayuse2_wdw3*5, dayuse2_wkw3*2)/7;
dayuse2w3h=dayuse2w3/60;


/*학원 및 과외시간*/
*평일;
if ytim1e01w3=1 then dayuse3_wdw3=0;
else if ytim1e01w3=2 then dayuse3_wdw3=15;
else if ytim1e01w3=3 then dayuse3_wdw3=45;
else if ytim1e01w3=4 then dayuse3_wdw3=90;
else if ytim1e01w3=5 then dayuse3_wdw3=150;
else if ytim1e01w3=6 then dayuse3_wdw3=210;
else if ytim1e01w3=7 then dayuse3_wdw3=270;
dayuse3_wdw3h=dayuse3_wdw3/60;
*주말;
if ytim1e02w3=1 then dayuse3_wkw3=0;
else if ytim1e02w3=2 then dayuse3_wkw3=15;
else if ytim1e02w3=3 then dayuse3_wkw3=45;
else if ytim1e02w3=4 then dayuse3_wkw3=90;
else if ytim1e02w3=5 then dayuse3_wkw3=150;
else if ytim1e02w3=6 then dayuse3_wkw3=210;
else if ytim1e02w3=7 then dayuse3_wkw3=270;
dayuse3_wkw3h=dayuse3_wkw3/60;
*일주일평균;
dayuse3w3=sum(dayuse3_wdw3*5, dayuse3_wkw3*2)/7;
dayuse3w3h=dayuse3w3/60;


/*인터넷 및 TV강의 시간*/
*평일;
if ytim1f01w3=1 then dayuse4_wdw3=0;
else if ytim1f01w3=2 then dayuse4_wdw3=15;
else if ytim1f01w3=3 then dayuse4_wdw3=45;
else if ytim1f01w3=4 then dayuse4_wdw3=90;
else if ytim1f01w3=5 then dayuse4_wdw3=150;
else if ytim1f01w3=6 then dayuse4_wdw3=210;
else if ytim1f01w3=7 then dayuse4_wdw3=270;
dayuse4_wdw3h=dayuse4_wdw3/60;
*주말;
if ytim1f02w3=1 then dayuse4_wkw3=0;
else if ytim1f02w3=2 then dayuse4_wkw3=15;
else if ytim1f02w3=3 then dayuse4_wkw3=45;
else if ytim1f02w3=4 then dayuse4_wkw3=90;
else if ytim1f02w3=5 then dayuse4_wkw3=150;
else if ytim1f02w3=6 then dayuse4_wkw3=210;
else if ytim1f02w3=7 then dayuse4_wkw3=270;
dayuse4_wkw3h=dayuse4_wkw3/60;
*일주일평균;
dayuse4w3=sum(dayuse4_wdw3*5, dayuse4_wkw3*2)/7;
dayuse4w3h=dayuse4w3/60;


/*방과 후 학교*/
*평일;
if ytim1g01w3=1 then dayuse5_wdw3=0;
else if ytim1g01w3=2 then dayuse5_wdw3=15;
else if ytim1g01w3=3 then dayuse5_wdw3=45;
else if ytim1g01w3=4 then dayuse5_wdw3=90;
else if ytim1g01w3=5 then dayuse5_wdw3=150;
else if ytim1g01w3=6 then dayuse5_wdw3=210;
else if ytim1g01w3=7 then dayuse5_wdw3=270;
dayuse5_wdw3h=dayuse5_wdw3/60;
*주말;
if ytim1g02w3=1 then dayuse5_wkw3=0;
else if ytim1g02w3=2 then dayuse5_wkw3=15;
else if ytim1g02w3=3 then dayuse5_wkw3=45;
else if ytim1g02w3=4 then dayuse5_wkw3=90;
else if ytim1g02w3=5 then dayuse5_wkw3=150;
else if ytim1g02w3=6 then dayuse5_wkw3=210;
else if ytim1g02w3=7 then dayuse5_wkw3=270;
dayuse5_wkw3h=dayuse5_wkw3/60;
*일주일평균;
dayuse5w3=sum(dayuse5_wdw3*5, dayuse5_wkw3*2)/7;
dayuse5w3h=dayuse5w3/60;


/*스스로 공부하는 시간*/
*평일;
if ytim1h01w3=1 then dayuse6_wdw3=0;
else if ytim1h01w3=2 then dayuse6_wdw3=15;
else if ytim1h01w3=3 then dayuse6_wdw3=45;
else if ytim1h01w3=4 then dayuse6_wdw3=90;
else if ytim1h01w3=5 then dayuse6_wdw3=150;
else if ytim1h01w3=6 then dayuse6_wdw3=210;
else if ytim1h01w3=7 then dayuse6_wdw3=270;
dayuse6_wdw3h=dayuse6_wdw3/60;
*주말;
if ytim1h02w3=1 then dayuse6_wkw3=0;
else if ytim1h02w3=2 then dayuse6_wkw3=15;
else if ytim1h02w3=3 then dayuse6_wkw3=45;
else if ytim1h02w3=4 then dayuse6_wkw3=90;
else if ytim1h02w3=5 then dayuse6_wkw3=150;
else if ytim1h02w3=6 then dayuse6_wkw3=210;
else if ytim1h02w3=7 then dayuse6_wkw3=270;
dayuse6_wkw3h=dayuse6_wkw3/60;
*일주일평균;
dayuse6w3=sum(dayuse6_wdw3*5, dayuse6_wkw3*2)/7;
dayuse6w3h=dayuse6w3/60;


/*독서시간*/
*평일;
if ytim1i01w3=1 then dayuse7_wdw3=0;
else if ytim1i01w3=2 then dayuse7_wdw3=15;
else if ytim1i01w3=3 then dayuse7_wdw3=45;
else if ytim1i01w3=4 then dayuse7_wdw3=90;
else if ytim1i01w3=5 then dayuse7_wdw3=150;
else if ytim1i01w3=6 then dayuse7_wdw3=210;
else if ytim1i01w3=7 then dayuse7_wdw3=270;
dayuse7_wdw3h=dayuse7_wdw3/60;
*주말;
if ytim1i02w3=1 then dayuse7_wkw3=0;
else if ytim1i02w3=2 then dayuse7_wkw3=15;
else if ytim1i02w3=3 then dayuse7_wkw3=45;
else if ytim1i02w3=4 then dayuse7_wkw3=90;
else if ytim1i02w3=5 then dayuse7_wkw3=150;
else if ytim1i02w3=6 then dayuse7_wkw3=210;
else if ytim1i02w3=7 then dayuse7_wkw3=270;
dayuse7_wkw3h=dayuse7_wkw3/60;
*일주일평균;
dayuse7w3=sum(dayuse7_wdw3*5, dayuse7_wkw3*2)/7;
dayuse7w3h=dayuse7w3/60;


/*운동 및 신체활동시간*/
*평일;
if ytim1j01w3=1 then dayuse8_wdw3=0;
else if ytim1j01w3=2 then dayuse8_wdw3=15;
else if ytim1j01w3=3 then dayuse8_wdw3=45;
else if ytim1j01w3=4 then dayuse8_wdw3=90;
else if ytim1j01w3=5 then dayuse8_wdw3=150;
else if ytim1j01w3=6 then dayuse8_wdw3=210;
else if ytim1j01w3=7 then dayuse8_wdw3=270;
dayuse8_wdw3h=dayuse8_wdw3/60;
*주말;
if ytim1j02w3=1 then dayuse8_wkw3=0;
else if ytim1j02w3=2 then dayuse8_wkw3=15;
else if ytim1j02w3=3 then dayuse8_wkw3=45;
else if ytim1j02w3=4 then dayuse8_wkw3=90;
else if ytim1j02w3=5 then dayuse8_wkw3=150;
else if ytim1j02w3=6 then dayuse8_wkw3=210;
else if ytim1j02w3=7 then dayuse8_wkw3=270;
dayuse8_wkw3h=dayuse8_wkw3/60;
*일주일평균;
dayuse8w3=sum(dayuse8_wdw3*5, dayuse8_wkw3*2)/7;
dayuse8w3h=dayuse8w3/60;


/*컴퓨터를 가지고노는시간*/
*평일;
if ytim1l01w3=1 then dayuse9_wdw3=0;
else if ytim1l01w3=2 then dayuse9_wdw3=15;
else if ytim1l01w3=3 then dayuse9_wdw3=45;
else if ytim1l01w3=4 then dayuse9_wdw3=90;
else if ytim1l01w3=5 then dayuse9_wdw3=150;
else if ytim1l01w3=6 then dayuse9_wdw3=210;
else if ytim1l01w3=7 then dayuse9_wdw3=270;
dayuse9_wdw3h=dayuse9_wdw3/60;
*주말;
if ytim1l02w3=1 then dayuse9_wkw3=0;
else if ytim1l02w3=2 then dayuse9_wkw3=15;
else if ytim1l02w3=3 then dayuse9_wkw3=45;
else if ytim1l02w3=4 then dayuse9_wkw3=90;
else if ytim1l02w3=5 then dayuse9_wkw3=150;
else if ytim1l02w3=6 then dayuse9_wkw3=210;
else if ytim1l02w3=7 then dayuse9_wkw3=270;
dayuse9_wkw3h=dayuse9_wkw3/60;
*일주일평균;
dayuse9w3=sum(dayuse9_wdw3*5, dayuse9_wkw3*2)/7;
dayuse9w3h=dayuse9w3/60;


/*TV시청*/
*평일;
if ytim1m01w3=1 then dayuse10_wdw3=0;
else if ytim1m01w3=2 then dayuse10_wdw3=15;
else if ytim1m01w3=3 then dayuse10_wdw3=45;
else if ytim1m01w3=4 then dayuse10_wdw3=90;
else if ytim1m01w3=5 then dayuse10_wdw3=150;
else if ytim1m01w3=6 then dayuse10_wdw3=210;
else if ytim1m01w3=7 then dayuse10_wdw3=270;
dayuse10_wdw3h=dayuse10_wdw3/60;
*주말;
if ytim1m02w3=1 then dayuse10_wkw3=0;
else if ytim1m02w3=2 then dayuse10_wkw3=15;
else if ytim1m02w3=3 then dayuse10_wkw3=45;
else if ytim1m02w3=4 then dayuse10_wkw3=90;
else if ytim1m02w3=5 then dayuse10_wkw3=150;
else if ytim1m02w3=6 then dayuse10_wkw3=210;
else if ytim1m02w3=7 then dayuse10_wkw3=270;
dayuse10_wkw3h=dayuse10_wkw3/60;
*일주일평균;
dayuse10w3=sum(dayuse10_wdw3*5, dayuse10_wkw3*2)/7;
dayuse10w3h=dayuse10w3/60;


/*친구들과 노는시간*/
*평일;
if ytim1n01w3=1 then dayuse11_wdw3=0;
else if ytim1n01w3=2 then dayuse11_wdw3=15;
else if ytim1n01w3=3 then dayuse11_wdw3=45;
else if ytim1n01w3=4 then dayuse11_wdw3=90;
else if ytim1n01w3=5 then dayuse11_wdw3=150;
else if ytim1n01w3=6 then dayuse11_wdw3=210;
else if ytim1n01w3=7 then dayuse11_wdw3=270;
dayuse11_wdw3h=dayuse11_wdw3/60;
*주말;
if ytim1n02w3=1 then dayuse11_wkw3=0;
else if ytim1n02w3=2 then dayuse11_wkw3=15;
else if ytim1n02w3=3 then dayuse11_wkw3=45;
else if ytim1n02w3=4 then dayuse11_wkw3=90;
else if ytim1n02w3=5 then dayuse11_wkw3=150;
else if ytim1n02w3=6 then dayuse11_wkw3=210;
else if ytim1n02w3=7 then dayuse11_wkw3=270;
dayuse11_wkw3h=dayuse11_wkw3/60;
*일주일평균;
dayuse11w3=sum(dayuse11_wdw3*5, dayuse11_wkw3*2)/7;
dayuse11w3h=dayuse11w3/60;


/*학업성적*/
*1-6 categories: 매우 못함 - 매우 잘함 - 잘 모르겠음;
if yint1a00w3 in (1,2,3) then gradew3=1;
else if yint1a00w3 in (4,5) then gradew3=2;
else gradew3=3;


/*부모의양육태도*/
*강요;
parcare1dw3=yfam2d01w3; *1-4 categoreis: 전혀 그렇지 않다 - 매우 그렇다;
parcare2dw3=yfam2d02w3; *1-4 categoreis: 전혀 그렇지 않다 - 매우 그렇다;
parcare3dw3=yfam2d03w3; *1-4 categoreis: 전혀 그렇지 않다 - 매우 그렇다;
parcare4dw3=yfam2d04w3; *1-4 categoreis: 전혀 그렇지 않다 - 매우 그렇다;
parcaresumw3=sum(parcare1dw3, parcare2dw3, parcare3dw3, parcare4dw3); *range 4-16;


/*부모님 동거여부*/
if pfam1a00w3 in(1,4) then famnumw3=2;
else famnumw3=1;


/*부모님학력*/
if pschool1w3 in (5,6,7) or pschool2w3 in (5,6,7) then pschoolw3=2;
else if pschool1w3 in (1:4) or pschool2w3 in (1:4) then pschoolw3=1;
else pschoolw3=2;


/*월평균가구소득*/
if pincomew3 in(1:3) then incomew3=1;
else if pincomew3 in(4,5) then incomew3=2;
else if pincomew3 in(6,7) then incomew3=3;
else if pincomew3=. then incomew3=3;
else if pincomew3 in(8,9) then incomew3=4;
else incomew3=5;

/*층화분석용 가구소득*/
if incomew3 in (1,2) then incomew3r=1;
else if incomew3=3 then incomew3r=2;
else if incomew3 in (4,5) then incomew3r=3;


/*아버지 직업*/
if pjob1w3 in (1,2,3) then fjobw3=1;
else if pjob1w3 in (4,5) then fjobw3=2;
else if pjob1w3 in (6:11) then fjobw3=3;
else fjobw3=4;


/*어머니 직업*/
if pjob2w3 in (1,2,3) then mjobw3=1;
else if pjob2w3 in (4,5) then mjobw3=2;
else if pjob2w3 in (6:11) then mjobw3=3;
else mjobw3=4;



/*학습시간(학원 및 과외, 인터넷 및 TV강의, 방과 후 학교, 스스로 공부하는 시간의 합)*/;
daystudy_wdw3=sum(dayuse3_wdw3h, dayuse4_wdw3h, dayuse5_wdw3h, dayuse6_wdw3h);
daystudy_wkw3=sum(dayuse3_wkw3h, dayuse4_wkw3h, dayuse5_wkw3h, dayuse6_wkw3h);
daystudyw3=sum(daystudy_wdw3*5, daystudy_wkw3*2)/7;

/*시간변수 24시간 단위로 변환*/
*일주일평균;
atimew3=24-sleep_all_h-25/7;
btimew3=sum(dayuse2w3h, daystudyw3, dayuse7w3h, dayuse8w3h, dayuse9w3h, dayuse10w3h, dayuse11w3h, sp_usew3h);
ctime2w3=(dayuse2w3h/btimew3)*atimew3;
ctimestudyw3=(daystudyw3/btimew3)*atimew3;
ctime7w3=(dayuse7w3h/btimew3)*atimew3;
ctime8w3=(dayuse8w3h/btimew3)*atimew3;
ctime9w3=(dayuse9w3h/btimew3)*atimew3;
ctime10w3=(dayuse10w3h/btimew3)*atimew3;
ctime11w3=(dayuse11w3h/btimew3)*atimew3;
ctimespw3=(sp_usew3h/btimew3)*atimew3;
ctimetstw3=sum(ctimespw3, ctime9w3, ctime10w3);
...
/* smartphone */
*sp_new;
if sp_usew3=. or sp_usew3=0 then sp_new=1;
else if 0<sp_usew3<60 then sp_new=2;
else if 60<=sp_usew3<120 then sp_new=3;
else if 120<=sp_usew3<180 then sp_new=4;
else if sp_usew3>=180 then sp_new=5;
*sp_re;
if sp_usew3=. or 0<=sp_usew3<60 then sp_re=2;
else if 60<=sp_usew3<120 then sp_re=3;
else if 120<=sp_usew3<180 then sp_re=4;
else if sp_usew3>=180 then sp_re=5;


*com_new;
if dayuse9w3=. or dayuse9w3=0 then com_new=1;
else if 0<dayuse9w3<60 then com_new=2;
else if 60<=dayuse9w3<120 then com_new=3;
else if dayuse9w3>=120 then com_new=4;
*com_re;
if dayuse9w3=. or 0<=dayuse9w3<60 then com_re=2;
else if 60<=dayuse9w3<120 then com_re=3;
else if dayuse9w3>=120 then com_re=4;


*tv_new;
if dayuse10w3=. or dayuse10w3=0 then tv_new=1;
else if 0<dayuse10w3<60 then tv_new=2;
else if 60<=dayuse10w3<120 then tv_new=3;
else if dayuse10w3>=120 then tv_new=4;
*tv_re;
if dayuse10w3=. or 0<=dayuse10w3<60 then tv_re=2;
else if 60<=dayuse10w3<120 then tv_re=3;
else if dayuse10w3>=120 then tv_re=4;


*total_new;
tstw3=sum(sp_usew3, dayuse9w3, dayuse10w3);
if tstw3=. or tstw3=0 then total_new=1;
else if 0<tstw3<120 then total_new=2;
else if 120<=tstw3<180 then total_new=3;
else if 180<=tstw3<240 then total_new=4;
else if tstw3>=240 then total_new=5;
*total_re;
if tstw3=. or 0<=tstw3<120 then total_re=2;
else if 120<=tstw3<180 then total_re=3;
else if 180<=tstw3<240 then total_re=4;
else if tstw3>=240 then total_re=5;
*total_60;
if tstw3=. or 0<=tstw3<60 then total_60=2;
else if 60<=tstw3<120 then total_60=3;
else if 120<=tstw3<180 then total_60=4;
else if 180<=tstw3<240 then total_60=5;
else if tstw3>=240 then total_60=6;
*total_60a;
if tstw3=. or tstw3=0 then total_60a=1;
else if 0<tstw3<60 then total_60a=2;
else if 60<=tstw3<120 then total_60a=3;
else if 120<=tstw3<180 then total_60a=4;
else if 180<=tstw3<240 then total_60a=5;
else if tstw3>=240 then total_60a=6;
