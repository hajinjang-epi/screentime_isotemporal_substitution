...
* 2018-2019;
data base1_e4; set e4; if obesityw1=1 then delete; if obesityw2 in (0,1); run;
data base1_m1; set m1; if obesityw1=1 then delete; if obesityw2 in (0,1); run;

*2019-2020;
data base2_e4; set e4; if obesityw2=1 then delete; if obesityw3 in (0,1); run;
data base2_m1; set m1; if obesityw2=1 then delete; if obesityw3 in (0,1); run;

*2020-2021;
data base3_e4; set e4; if obesityw3=1 then delete; if obesityw4 in (0,1); run;
data base3_m1; set m1; if obesityw3=1 then delete; if obesityw4 in (0,1); run;


* 2018-2020;
data base4_e4; set e4; if obesityw1=1 then delete; if obesityw2 in (0,1) and obesityw3 in (0,1); 
if obesityw2=1 or obesityw3=1 then obesity1920=1; else obesity1920=0;
run;

data base4_m1; set m1; if obesityw1=1 then delete; if obesityw2 in (0,1) and obesityw3 in (0,1); 
if obesityw2=1 or obesityw3=1 then obesity1920=1; else obesity1920=0;
run;
...
else if bmi_cw1=3 then bmicatw1=2;
else if bmi_cw1=2 then bmicatw1=3;
else if bmi_cw1=1 then bmicatw1=4;
end;

if bmi_cw4 ne . then do;
if bmi_cw4=4 then bmicatw4=1;
else if bmi_cw4=3 then bmicatw4=2;
else if bmi_cw4=2 then bmicatw4=3;
else if bmi_cw4=1 then bmicatw4=4;
end;
run;
